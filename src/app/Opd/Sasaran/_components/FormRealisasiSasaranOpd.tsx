...
const FormRealisasiSasaranOpd: React.FC<FormProps<SasaranOpdTargetRealisasiCapaian[], SasaranOpdRealisasi[]> & { tahun: number; bulan: string; bulanLabel?: string }> = ({
    requestValues,
    onClose,
    onSuccess,
    tahun,
...
// fill data awal
    ...
    }, [requestValues, normalizedBulan, bulanLabel]);
